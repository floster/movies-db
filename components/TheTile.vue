<template>
  <article
    class="grid gap-y-2 pb-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm shadow-slate-300 dark:shadow-slate-800 hover:shadow-md hover:shadow-sky-300 dark:hover:shadow-sky-800 overflow-hidden"
  >
    <NuxtPicture
      densities="1x, 2x"
      placeholder
