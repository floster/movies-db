...
<template>
  <article
    class="tile flex flex-col gap-y-2 pb-4 bg-white dark:bg-gray-800 rounded-lg shadow shadow-gray-400 dark:shadow-gray-950 hover:shadow-md hover:shadow-sky-300 dark:hover:shadow-indigo-800 overflow-hidden"
  >
    <NuxtPicture
      densities="1x, 2x"
      placeholder
    ...
    <header class="flex flex-col gap-2 px-2 lg:px-4">
      <p class="text-sky-600 dark:text-sky-500">
        {{ label }}
      </p>
